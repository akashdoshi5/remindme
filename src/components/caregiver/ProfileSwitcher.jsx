                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="absolute left-0 md:left-auto md:right-0 top-full mt-2 w-64 bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-100 dark:border-gray-800 z-50 overflow-hidden"
                        >
